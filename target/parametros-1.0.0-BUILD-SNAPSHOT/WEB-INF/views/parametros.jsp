      ...
      <div class="content-wrapper" ng-controller="ParametrosController as paramsCtrl">
	        ...
	        <section class="content-header">
	          <h1 class="text-info">
	            ...
	            <small>
	            	({{ paramsCtrl.aplicacao.descricao }})
						                    ...
						                    <div class="form-group col-md-6">
							                  ...
							                  <div class="form-group col-md-3">
							                    ...
							                    <div class="input-group">
							                      ...
							                      <input type="text" class="form-control pull-right input-sm" ng-model="paramsCtrl.perfil.parad1"/>
							                    </div><!-- /.input group -->
							                  </div><!-- /.form group -->	
							                  <div class="form-group col-md-3">
							                    <label>(2):</label>
							                    <div class="input-group">
							                      ...
							                      <input type="text" class="form-control pull-right input-sm" ng-model="paramsCtrl.perfil.parad2"/>
							                    </div><!-- /.input group -->
							                  </div><!-- /.form group -->	
							                  <div class="form-group col-md-3">
							                    <label>(3):</label>
							                    <div class="input-group">
							                      ...
							                      <input type="text" class="form-control pull-right input-sm" ng-model="paramsCtrl.perfil.parad3"/>
							                    </div><!-- /.input group -->
							                  </div><!-- /.form group -->	
							                  <div class="form-group col-md-3">
							                    <label>(4):</label>
							                    <div class="input-group">
							                      ...
							                      <input type="text" class="form-control pull-right input-sm" ng-model="paramsCtrl.perfil.parad4"/>
							                    </div><!-- /.input group -->
							                  </div><!-- /.form group -->	
							                  
						                    <div class="form-group col-md-2">
						                      <label>Numeros(1):</label>
						                      <input type="text" class="form-control input-sm" ng-model="paramsCtrl.perfil.paran1"/>
						                    </div>						                  				                    
						                    <div class="form-group col-md-2">
						                      <label>(2):</label>
						                      <input type="text" class="form-control input-sm" ng-model="paramsCtrl.perfil.paran2"/>
						                    </div>						                  				                    
						                    <div class="form-group col-md-2">
						                      <label>(3):</label>
						                      <input type="text" class="form-control input-sm" ng-model="paramsCtrl.perfil.paran3"/>
						                    </div>						                  				                    
						                    <div class="form-group col-md-2">
						                      <label>(4):</label>
						                      <input type="text" class="form-control input-sm" ng-model="paramsCtrl.perfil.paran4"/>
						                    </div>						                  				                    
						                    <div class="form-group col-md-2">
						                      <label>(5):</label>
						                      <input type="text" class="form-control input-sm" ng-model="paramsCtrl.perfil.paran5"/>
						                    </div>						                  				                    
						                    <div class="form-group col-md-2">
						                      <label>(6):</label>
						                      <input type="text" class="form-control input-sm" ng-model="paramsCtrl.perfil.paran6"/>
						                    </div>			
							                  	...
							                  	<div class="row">
								                  	<div class="col-md-7">
									                    ...
									                    <div class="form-group col-md-3">
									                      ...
									                      <input type="text" class="form-control input-sm" maxlength="10" ng-model="paramsCtrl.aplicacaoPerfil.parad1"/>
									                    </div>					                  			
									                    <div class="form-group col-md-3">
									                      <label>(2)</label>
									                      <input type="text" class="form-control input-sm" maxlength="10" ng-model="paramsCtrl.aplicacaoPerfil.parad2"/>
									                    </div>					                  			
									                    <div class="form-group col-md-3">
									                      <label>(3)</label>
									                      <input type="text" class="form-control input-sm" maxlength="10" ng-model="paramsCtrl.aplicacaoPerfil.parad3"/>
									                    </div>					                  			
									                    <div class="form-group col-md-3">
									                      <label>(4)</label>
									                      <input type="text" class="form-control input-sm" maxlength="10" ng-model="paramsCtrl.aplicacaoPerfil.parad4"/>
									                    </div>					                  			
									                    <div class="form-group col-md-2">
									                      <label><small>Numeros</small>(1)</label>
									                      <input type="text" class="form-control input-sm" ng-model="paramsCtrl.aplicacaoPerfil.paran1"/>
									                    </div>					                  			
									                    <div class="form-group col-md-2">
									                      <label>(2)</label>
									                      <input type="text" class="form-control input-sm" ng-model="paramsCtrl.aplicacaoPerfil.paran2"/>
									                    </div>					                  			
									                    <div class="form-group col-md-2">
									                      <label>(3)</label>
									                      <input type="text" class="form-control input-sm" ng-model="paramsCtrl.aplicacaoPerfil.paran3"/>
									                    </div>					                  			
									                    <div class="form-group col-md-2">
									                      <label>(4)</label>
									                      <input type="text" class="form-control input-sm" ng-model="paramsCtrl.aplicacaoPerfil.paran4"/>
									                    </div>					                  			
									                    <div class="form-group col-md-2">
									                      <label>(5)</label>
									                      <input type="text" class="form-control input-sm" ng-model="paramsCtrl.aplicacaoPerfil.paran5"/>
									                    </div>					                  			
									                    <div class="form-group col-md-2">
									                      <label>(6)</label>
									                      <input type="text" class="form-control input-sm" ng-model="paramsCtrl.aplicacaoPerfil.paran6"/>
									                    </div>				
									                    <div class="form-group col-md-12">
									                      <label>Texto</label>
